...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "partitions_table.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "partitions_table.csv"
...
#define CONFIG_WIFI_PROV_SCAN_MAX_ENTRIES 20

...
#include <stdint.h>
#include <stdlib.h>
//#include "multi_heap.h"   // NOTE: header modified here
#include <sdkconfig.h>
#include "esp_err.h"
...
#include <stdbool.h>    // NOTE: header modified here
 ...
 *
 */
//void heap_caps_get_info( multi_heap_info_t *info, uint32_t caps ); // NOTE: header modified here

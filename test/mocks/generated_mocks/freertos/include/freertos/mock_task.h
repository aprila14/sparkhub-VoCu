...
#define xTaskCreatePinnedToCore_IgnoreAndReturn(cmock_retval) xTaskCreatePinnedToCore_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void xTaskCreatePinnedToCore_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, BaseType_t cmock_to_return);
#define xTaskCreatePinnedToCore_StopIgnore() xTaskCreatePinnedToCore_CMockStopIgnore()
void xTaskCreatePinnedToCore_CMockStopIgnore(void);
#define xTaskCreatePinnedToCore_ExpectAndReturn(pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pvCreatedTask, xCoreID, cmock_retval) xTaskCreatePinnedToCore_CMockExpectAndReturn(__LINE__, pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pvCreatedTask, xCoreID, cmock_retval)
...
typedef BaseType_t (* CMOCK_xTaskCreatePinnedToCore_CALLBACK)(TaskFunction_t pvTaskCode, const char* const pcName, const uint32_t usStackDepth, void* const pvParameters, UBaseType_t uxPriority, TaskHandle_t* const pvCreatedTask, const BaseType_t xCoreID, int cmock_num_calls);
...
#define xTaskCreatePinnedToCore_StubWithCallback xTaskCreatePinnedToCore_Stub
#define xTaskCreatePinnedToCore_ExpectWithArrayAndReturn(pvTaskCode, pcName, usStackDepth, pvParameters, pvParameters_Depth, uxPriority, pvCreatedTask, pvCreatedTask_Depth, xCoreID, cmock_retval) xTaskCreatePinnedToCore_CMockExpectWithArrayAndReturn(__LINE__, pvTaskCode, pcName, usStackDepth, pvParameters, pvParameters_Depth, uxPriority, pvCreatedTask, pvCreatedTask_Depth, xCoreID, cmock_retval)
...
#define xTaskCreatePinnedToCore_ReturnThruPtr_pvParameters(pvParameters) xTaskCreatePinnedToCore_CMockReturnMemThruPtr_pvParameters(__LINE__, pvParameters, sizeof(void))
#define xTaskCreatePinnedToCore_ReturnArrayThruPtr_pvParameters(pvParameters, cmock_len) xTaskCreatePinnedToCore_CMockReturnMemThruPtr_pvParameters(__LINE__, pvParameters, cmock_len * sizeof(*pvParameters))
#define xTaskCreatePinnedToCore_ReturnMemThruPtr_pvParameters(pvParameters, cmock_size) xTaskCreatePinnedToCore_CMockReturnMemThruPtr_pvParameters(__LINE__, pvParameters, cmock_size)
...
#define xTaskCreatePinnedToCore_ReturnThruPtr_pvCreatedTask(pvCreatedTask) xTaskCreatePinnedToCore_CMockReturnMemThruPtr_pvCreatedTask(__LINE__, pvCreatedTask, sizeof(TaskHandle_t))
#define xTaskCreatePinnedToCore_ReturnArrayThruPtr_pvCreatedTask(pvCreatedTask, cmock_len) xTaskCreatePinnedToCore_CMockReturnMemThruPtr_pvCreatedTask(__LINE__, pvCreatedTask, cmock_len * sizeof(*pvCreatedTask))
#define xTaskCreatePinnedToCore_ReturnMemThruPtr_pvCreatedTask(pvCreatedTask, cmock_size) xTaskCreatePinnedToCore_CMockReturnMemThruPtr_pvCreatedTask(__LINE__, pvCreatedTask, cmock_size)
...
#define xTaskCreatePinnedToCore_IgnoreArg_pvTaskCode() xTaskCreatePinnedToCore_CMockIgnoreArg_pvTaskCode(__LINE__)
void xTaskCreatePinnedToCore_CMockIgnoreArg_pvTaskCode(UNITY_LINE_TYPE cmock_line);
#define xTaskCreatePinnedToCore_IgnoreArg_pcName() xTaskCreatePinnedToCore_CMockIgnoreArg_pcName(__LINE__)
void xTaskCreatePinnedToCore_CMockIgnoreArg_pcName(UNITY_LINE_TYPE cmock_line);
#define xTaskCreatePinnedToCore_IgnoreArg_usStackDepth() xTaskCreatePinnedToCore_CMockIgnoreArg_usStackDepth(__LINE__)
void xTaskCreatePinnedToCore_CMockIgnoreArg_usStackDepth(UNITY_LINE_TYPE cmock_line);
#define xTaskCreatePinnedToCore_IgnoreArg_pvParameters() xTaskCreatePinnedToCore_CMockIgnoreArg_pvParameters(__LINE__)
void xTaskCreatePinnedToCore_CMockIgnoreArg_pvParameters(UNITY_LINE_TYPE cmock_line);
#define xTaskCreatePinnedToCore_IgnoreArg_uxPriority() xTaskCreatePinnedToCore_CMockIgnoreArg_uxPriority(__LINE__)
void xTaskCreatePinnedToCore_CMockIgnoreArg_uxPriority(UNITY_LINE_TYPE cmock_line);
#define xTaskCreatePinnedToCore_IgnoreArg_pvCreatedTask() xTaskCreatePinnedToCore_CMockIgnoreArg_pvCreatedTask(__LINE__)
void xTaskCreatePinnedToCore_CMockIgnoreArg_pvCreatedTask(UNITY_LINE_TYPE cmock_line);
#define xTaskCreatePinnedToCore_IgnoreArg_xCoreID() xTaskCreatePinnedToCore_CMockIgnoreArg_xCoreID(__LINE__)
void xTaskCreatePinnedToCore_CMockIgnoreArg_xCoreID(UNITY_LINE_TYPE cmock_line);
#define xTaskCreateStaticPinnedToCore_IgnoreAndReturn(cmock_retval) xTaskCreateStaticPinnedToCore_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void xTaskCreateStaticPinnedToCore_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, TaskHandle_t cmock_to_return);
#define xTaskCreateStaticPinnedToCore_StopIgnore() xTaskCreateStaticPinnedToCore_CMockStopIgnore()
void xTaskCreateStaticPinnedToCore_CMockStopIgnore(void);
#define xTaskCreateStaticPinnedToCore_ExpectAndReturn(pvTaskCode, pcName, ulStackDepth, pvParameters, uxPriority, pxStackBuffer, pxTaskBuffer, xCoreID, cmock_retval) xTaskCreateStaticPinnedToCore_CMockExpectAndReturn(__LINE__, pvTaskCode, pcName, ulStackDepth, pvParameters, uxPriority, pxStackBuffer, pxTaskBuffer, xCoreID, cmock_retval)
...
typedef TaskHandle_t (* CMOCK_xTaskCreateStaticPinnedToCore_CALLBACK)(TaskFunction_t pvTaskCode, const char* const pcName, const uint32_t ulStackDepth, void* const pvParameters, UBaseType_t uxPriority, StackType_t* const pxStackBuffer, StaticTask_t* const pxTaskBuffer, const BaseType_t xCoreID, int cmock_num_calls);
...
#define xTaskCreateStaticPinnedToCore_StubWithCallback xTaskCreateStaticPinnedToCore_Stub
#define xTaskCreateStaticPinnedToCore_ExpectWithArrayAndReturn(pvTaskCode, pcName, ulStackDepth, pvParameters, pvParameters_Depth, uxPriority, pxStackBuffer, pxStackBuffer_Depth, pxTaskBuffer, pxTaskBuffer_Depth, xCoreID, cmock_retval) xTaskCreateStaticPinnedToCore_CMockExpectWithArrayAndReturn(__LINE__, pvTaskCode, pcName, ulStackDepth, pvParameters, pvParameters_Depth, uxPriority, pxStackBuffer, pxStackBuffer_Depth, pxTaskBuffer, pxTaskBuffer_Depth, xCoreID, cmock_retval)
...
#define xTaskCreateStaticPinnedToCore_ReturnThruPtr_pvParameters(pvParameters) xTaskCreateStaticPinnedToCore_CMockReturnMemThruPtr_pvParameters(__LINE__, pvParameters, sizeof(void))
#define xTaskCreateStaticPinnedToCore_ReturnArrayThruPtr_pvParameters(pvParameters, cmock_len) xTaskCreateStaticPinnedToCore_CMockReturnMemThruPtr_pvParameters(__LINE__, pvParameters, cmock_len * sizeof(*pvParameters))
#define xTaskCreateStaticPinnedToCore_ReturnMemThruPtr_pvParameters(pvParameters, cmock_size) xTaskCreateStaticPinnedToCore_CMockReturnMemThruPtr_pvParameters(__LINE__, pvParameters, cmock_size)
...
#define xTaskCreateStaticPinnedToCore_ReturnThruPtr_pxStackBuffer(pxStackBuffer) xTaskCreateStaticPinnedToCore_CMockReturnMemThruPtr_pxStackBuffer(__LINE__, pxStackBuffer, sizeof(StackType_t))
#define xTaskCreateStaticPinnedToCore_ReturnArrayThruPtr_pxStackBuffer(pxStackBuffer, cmock_len) xTaskCreateStaticPinnedToCore_CMockReturnMemThruPtr_pxStackBuffer(__LINE__, pxStackBuffer, cmock_len * sizeof(*pxStackBuffer))
#define xTaskCreateStaticPinnedToCore_ReturnMemThruPtr_pxStackBuffer(pxStackBuffer, cmock_size) xTaskCreateStaticPinnedToCore_CMockReturnMemThruPtr_pxStackBuffer(__LINE__, pxStackBuffer, cmock_size)
...
#define xTaskCreateStaticPinnedToCore_ReturnThruPtr_pxTaskBuffer(pxTaskBuffer) xTaskCreateStaticPinnedToCore_CMockReturnMemThruPtr_pxTaskBuffer(__LINE__, pxTaskBuffer, sizeof(StaticTask_t))
#define xTaskCreateStaticPinnedToCore_ReturnArrayThruPtr_pxTaskBuffer(pxTaskBuffer, cmock_len) xTaskCreateStaticPinnedToCore_CMockReturnMemThruPtr_pxTaskBuffer(__LINE__, pxTaskBuffer, cmock_len * sizeof(*pxTaskBuffer))
#define xTaskCreateStaticPinnedToCore_ReturnMemThruPtr_pxTaskBuffer(pxTaskBuffer, cmock_size) xTaskCreateStaticPinnedToCore_CMockReturnMemThruPtr_pxTaskBuffer(__LINE__, pxTaskBuffer, cmock_size)
...
#define xTaskCreateStaticPinnedToCore_IgnoreArg_pvTaskCode() xTaskCreateStaticPinnedToCore_CMockIgnoreArg_pvTaskCode(__LINE__)
void xTaskCreateStaticPinnedToCore_CMockIgnoreArg_pvTaskCode(UNITY_LINE_TYPE cmock_line);
#define xTaskCreateStaticPinnedToCore_IgnoreArg_pcName() xTaskCreateStaticPinnedToCore_CMockIgnoreArg_pcName(__LINE__)
void xTaskCreateStaticPinnedToCore_CMockIgnoreArg_pcName(UNITY_LINE_TYPE cmock_line);
#define xTaskCreateStaticPinnedToCore_IgnoreArg_ulStackDepth() xTaskCreateStaticPinnedToCore_CMockIgnoreArg_ulStackDepth(__LINE__)
void xTaskCreateStaticPinnedToCore_CMockIgnoreArg_ulStackDepth(UNITY_LINE_TYPE cmock_line);
#define xTaskCreateStaticPinnedToCore_IgnoreArg_pvParameters() xTaskCreateStaticPinnedToCore_CMockIgnoreArg_pvParameters(__LINE__)
void xTaskCreateStaticPinnedToCore_CMockIgnoreArg_pvParameters(UNITY_LINE_TYPE cmock_line);
#define xTaskCreateStaticPinnedToCore_IgnoreArg_uxPriority() xTaskCreateStaticPinnedToCore_CMockIgnoreArg_uxPriority(__LINE__)
void xTaskCreateStaticPinnedToCore_CMockIgnoreArg_uxPriority(UNITY_LINE_TYPE cmock_line);
#define xTaskCreateStaticPinnedToCore_IgnoreArg_pxStackBuffer() xTaskCreateStaticPinnedToCore_CMockIgnoreArg_pxStackBuffer(__LINE__)
void xTaskCreateStaticPinnedToCore_CMockIgnoreArg_pxStackBuffer(UNITY_LINE_TYPE cmock_line);
#define xTaskCreateStaticPinnedToCore_IgnoreArg_pxTaskBuffer() xTaskCreateStaticPinnedToCore_CMockIgnoreArg_pxTaskBuffer(__LINE__)
void xTaskCreateStaticPinnedToCore_CMockIgnoreArg_pxTaskBuffer(UNITY_LINE_TYPE cmock_line);
#define xTaskCreateStaticPinnedToCore_IgnoreArg_xCoreID() xTaskCreateStaticPinnedToCore_CMockIgnoreArg_xCoreID(__LINE__)
...
typedef BaseType_t (* CMOCK_xTaskDelayUntil_CALLBACK)(TickType_t* const pxPreviousWakeTime, const TickType_t xTimeIncrement, int cmock_num_calls);
...
#define xTaskDelayUntil_ExpectWithArrayAndReturn(pxPreviousWakeTime, pxPreviousWakeTime_Depth, xTimeIncrement, cmock_retval) xTaskDelayUntil_CMockExpectWithArrayAndReturn(__LINE__, pxPreviousWakeTime, pxPreviousWakeTime_Depth, xTimeIncrement, cmock_retval)
...
#define pxTaskGetStackStart_IgnoreAndReturn(cmock_retval) pxTaskGetStackStart_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void pxTaskGetStackStart_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, uint8_t* cmock_to_return);
#define pxTaskGetStackStart_StopIgnore() pxTaskGetStackStart_CMockStopIgnore()
void pxTaskGetStackStart_CMockStopIgnore(void);
#define pxTaskGetStackStart_ExpectAndReturn(xTask, cmock_retval) pxTaskGetStackStart_CMockExpectAndReturn(__LINE__, xTask, cmock_retval)
void pxTaskGetStackStart_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, TaskHandle_t xTask, uint8_t* cmock_to_return);
typedef uint8_t* (* CMOCK_pxTaskGetStackStart_CALLBACK)(TaskHandle_t xTask, int cmock_num_calls);
...
#define pxTaskGetStackStart_StubWithCallback pxTaskGetStackStart_Stub
#define pxTaskGetStackStart_IgnoreArg_xTask() pxTaskGetStackStart_CMockIgnoreArg_xTask(__LINE__)
...
#define vTaskSetThreadLocalStoragePointerAndDelCallback_Ignore() vTaskSetThreadLocalStoragePointerAndDelCallback_CMockIgnore()
void vTaskSetThreadLocalStoragePointerAndDelCallback_CMockIgnore(void);
#define vTaskSetThreadLocalStoragePointerAndDelCallback_StopIgnore() vTaskSetThreadLocalStoragePointerAndDelCallback_CMockStopIgnore()
void vTaskSetThreadLocalStoragePointerAndDelCallback_CMockStopIgnore(void);
#define vTaskSetThreadLocalStoragePointerAndDelCallback_Expect(xTaskToSet, xIndex, pvValue, pvDelCallback) vTaskSetThreadLocalStoragePointerAndDelCallback_CMockExpect(__LINE__, xTaskToSet, xIndex, pvValue, pvDelCallback)
...
typedef void (* CMOCK_vTaskSetThreadLocalStoragePointerAndDelCallback_CALLBACK)(TaskHandle_t xTaskToSet, BaseType_t xIndex, void* pvValue, TlsDeleteCallbackFunction_t pvDelCallback, int cmock_num_calls);
...
#define vTaskSetThreadLocalStoragePointerAndDelCallback_StubWithCallback vTaskSetThreadLocalStoragePointerAndDelCallback_Stub
#define vTaskSetThreadLocalStoragePointerAndDelCallback_ExpectWithArray(xTaskToSet, xIndex, pvValue, pvValue_Depth, pvDelCallback) vTaskSetThreadLocalStoragePointerAndDelCallback_CMockExpectWithArray(__LINE__, xTaskToSet, xIndex, pvValue, pvValue_Depth, pvDelCallback)
...
#define vTaskSetThreadLocalStoragePointerAndDelCallback_ReturnThruPtr_pvValue(pvValue) vTaskSetThreadLocalStoragePointerAndDelCallback_CMockReturnMemThruPtr_pvValue(__LINE__, pvValue, sizeof(void))
#define vTaskSetThreadLocalStoragePointerAndDelCallback_ReturnArrayThruPtr_pvValue(pvValue, cmock_len) vTaskSetThreadLocalStoragePointerAndDelCallback_CMockReturnMemThruPtr_pvValue(__LINE__, pvValue, cmock_len * sizeof(*pvValue))
#define vTaskSetThreadLocalStoragePointerAndDelCallback_ReturnMemThruPtr_pvValue(pvValue, cmock_size) vTaskSetThreadLocalStoragePointerAndDelCallback_CMockReturnMemThruPtr_pvValue(__LINE__, pvValue, cmock_size)
...
#define vTaskSetThreadLocalStoragePointerAndDelCallback_IgnoreArg_xTaskToSet() vTaskSetThreadLocalStoragePointerAndDelCallback_CMockIgnoreArg_xTaskToSet(__LINE__)
void vTaskSetThreadLocalStoragePointerAndDelCallback_CMockIgnoreArg_xTaskToSet(UNITY_LINE_TYPE cmock_line);
#define vTaskSetThreadLocalStoragePointerAndDelCallback_IgnoreArg_xIndex() vTaskSetThreadLocalStoragePointerAndDelCallback_CMockIgnoreArg_xIndex(__LINE__)
void vTaskSetThreadLocalStoragePointerAndDelCallback_CMockIgnoreArg_xIndex(UNITY_LINE_TYPE cmock_line);
#define vTaskSetThreadLocalStoragePointerAndDelCallback_IgnoreArg_pvValue() vTaskSetThreadLocalStoragePointerAndDelCallback_CMockIgnoreArg_pvValue(__LINE__)
void vTaskSetThreadLocalStoragePointerAndDelCallback_CMockIgnoreArg_pvValue(UNITY_LINE_TYPE cmock_line);
#define vTaskSetThreadLocalStoragePointerAndDelCallback_IgnoreArg_pvDelCallback() vTaskSetThreadLocalStoragePointerAndDelCallback_CMockIgnoreArg_pvDelCallback(__LINE__)
void vTaskSetThreadLocalStoragePointerAndDelCallback_CMockIgnoreArg_pvDelCallback(UNITY_LINE_TYPE cmock_line);
#define vApplicationStackOverflowHook_Ignore() vApplicationStackOverflowHook_CMockIgnore()
void vApplicationStackOverflowHook_CMockIgnore(void);
#define vApplicationStackOverflowHook_StopIgnore() vApplicationStackOverflowHook_CMockStopIgnore()
...
typedef void (* CMOCK_vApplicationStackOverflowHook_CALLBACK)(TaskHandle_t xTask, char* pcTaskName, int cmock_num_calls);
...
#define vApplicationStackOverflowHook_StubWithCallback vApplicationStackOverflowHook_Stub
...
#define vApplicationTickHook_Ignore() vApplicationTickHook_CMockIgnore()
void vApplicationTickHook_CMockIgnore(void);
#define vApplicationTickHook_StopIgnore() vApplicationTickHook_CMockStopIgnore()
...
typedef void (* CMOCK_vApplicationTickHook_CALLBACK)(int cmock_num_calls);
...
#define vApplicationTickHook_StubWithCallback vApplicationTickHook_Stub
#define vApplicationGetIdleTaskMemory_Ignore() vApplicationGetIdleTaskMemory_CMockIgnore()
void vApplicationGetIdleTaskMemory_CMockIgnore(void);
#define vApplicationGetIdleTaskMemory_StopIgnore() vApplicationGetIdleTaskMemory_CMockStopIgnore()
void vApplicationGetIdleTaskMemory_CMockStopIgnore(void);
#define vApplicationGetIdleTaskMemory_Expect(ppxIdleTaskTCBBuffer, ppxIdleTaskStackBuffer, pulIdleTaskStackSize) vApplicationGetIdleTaskMemory_CMockExpect(__LINE__, ppxIdleTaskTCBBuffer, ppxIdleTaskStackBuffer, pulIdleTaskStackSize)
...
typedef void (* CMOCK_vApplicationGetIdleTaskMemory_CALLBACK)(StaticTask_t** ppxIdleTaskTCBBuffer, StackType_t** ppxIdleTaskStackBuffer, uint32_t* pulIdleTaskStackSize, int cmock_num_calls);
...
#define vApplicationGetIdleTaskMemory_StubWithCallback vApplicationGetIdleTaskMemory_Stub
#define vApplicationGetIdleTaskMemory_ExpectWithArray(ppxIdleTaskTCBBuffer, ppxIdleTaskTCBBuffer_Depth, ppxIdleTaskStackBuffer, ppxIdleTaskStackBuffer_Depth, pulIdleTaskStackSize, pulIdleTaskStackSize_Depth) vApplicationGetIdleTaskMemory_CMockExpectWithArray(__LINE__, ppxIdleTaskTCBBuffer, ppxIdleTaskTCBBuffer_Depth, ppxIdleTaskStackBuffer, ppxIdleTaskStackBuffer_Depth, pulIdleTaskStackSize, pulIdleTaskStackSize_Depth)
...
#define vApplicationGetIdleTaskMemory_ReturnThruPtr_pulIdleTaskStackSize(pulIdleTaskStackSize) vApplicationGetIdleTaskMemory_CMockReturnMemThruPtr_pulIdleTaskStackSize(__LINE__, pulIdleTaskStackSize, sizeof(uint32_t))
#define vApplicationGetIdleTaskMemory_ReturnArrayThruPtr_pulIdleTaskStackSize(pulIdleTaskStackSize, cmock_len) vApplicationGetIdleTaskMemory_CMockReturnMemThruPtr_pulIdleTaskStackSize(__LINE__, pulIdleTaskStackSize, cmock_len * sizeof(*pulIdleTaskStackSize))
#define vApplicationGetIdleTaskMemory_ReturnMemThruPtr_pulIdleTaskStackSize(pulIdleTaskStackSize, cmock_size) vApplicationGetIdleTaskMemory_CMockReturnMemThruPtr_pulIdleTaskStackSize(__LINE__, pulIdleTaskStackSize, cmock_size)
...
#define vApplicationGetIdleTaskMemory_IgnoreArg_pulIdleTaskStackSize() vApplicationGetIdleTaskMemory_CMockIgnoreArg_pulIdleTaskStackSize(__LINE__)
...
#define vTaskList_ReturnArrayThruPtr_pcWriteBuffer(pcWriteBuffer, cmock_len) vTaskList_CMockReturnMemThruPtr_pcWriteBuffer(__LINE__, pcWriteBuffer, cmock_len * sizeof(*pcWriteBuffer))
...
#define vTaskGetRunTimeStats_ReturnArrayThruPtr_pcWriteBuffer(pcWriteBuffer, cmock_len) vTaskGetRunTimeStats_CMockReturnMemThruPtr_pcWriteBuffer(__LINE__, pcWriteBuffer, cmock_len * sizeof(*pcWriteBuffer))
...
typedef BaseType_t (* CMOCK_xTaskGenericNotify_CALLBACK)(TaskHandle_t xTaskToNotify, UBaseType_t uxIndexToNotify, uint32_t ulValue, eNotifyAction eAction, uint32_t* pulPreviousNotificationValue, int cmock_num_calls);
...
typedef BaseType_t (* CMOCK_xTaskGenericNotifyFromISR_CALLBACK)(TaskHandle_t xTaskToNotify, UBaseType_t uxIndexToNotify, uint32_t ulValue, eNotifyAction eAction, uint32_t* pulPreviousNotificationValue, BaseType_t* pxHigherPriorityTaskWoken, int cmock_num_calls);
...
#define xTaskGenericNotifyFromISR_ExpectWithArrayAndReturn(xTaskToNotify, uxIndexToNotify, ulValue, eAction, pulPreviousNotificationValue, pulPreviousNotificationValue_Depth, pxHigherPriorityTaskWoken, pxHigherPriorityTaskWoken_Depth, cmock_retval) xTaskGenericNotifyFromISR_CMockExpectWithArrayAndReturn(__LINE__, xTaskToNotify, uxIndexToNotify, ulValue, eAction, pulPreviousNotificationValue, pulPreviousNotificationValue_Depth, pxHigherPriorityTaskWoken, pxHigherPriorityTaskWoken_Depth, cmock_retval)
...
#define xTaskGenericNotifyWait_IgnoreAndReturn(cmock_retval) xTaskGenericNotifyWait_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void xTaskGenericNotifyWait_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, BaseType_t cmock_to_return);
#define xTaskGenericNotifyWait_StopIgnore() xTaskGenericNotifyWait_CMockStopIgnore()
...
typedef BaseType_t (* CMOCK_xTaskGenericNotifyWait_CALLBACK)(UBaseType_t uxIndexToWaitOn, uint32_t ulBitsToClearOnEntry, uint32_t ulBitsToClearOnExit, uint32_t* pulNotificationValue, TickType_t xTicksToWait, int cmock_num_calls);
...
#define xTaskGenericNotifyWait_StubWithCallback xTaskGenericNotifyWait_Stub
#define xTaskGenericNotifyWait_ExpectWithArrayAndReturn(uxIndexToWaitOn, ulBitsToClearOnEntry, ulBitsToClearOnExit, pulNotificationValue, pulNotificationValue_Depth, xTicksToWait, cmock_retval) xTaskGenericNotifyWait_CMockExpectWithArrayAndReturn(__LINE__, uxIndexToWaitOn, ulBitsToClearOnEntry, ulBitsToClearOnExit, pulNotificationValue, pulNotificationValue_Depth, xTicksToWait, cmock_retval)
...
#define vTaskGenericNotifyGiveFromISR_Ignore() vTaskGenericNotifyGiveFromISR_CMockIgnore()
void vTaskGenericNotifyGiveFromISR_CMockIgnore(void);
#define vTaskGenericNotifyGiveFromISR_StopIgnore() vTaskGenericNotifyGiveFromISR_CMockStopIgnore()
...
typedef void (* CMOCK_vTaskGenericNotifyGiveFromISR_CALLBACK)(TaskHandle_t xTaskToNotify, UBaseType_t uxIndexToNotify, BaseType_t* pxHigherPriorityTaskWoken, int cmock_num_calls);
...
#define vTaskGenericNotifyGiveFromISR_StubWithCallback vTaskGenericNotifyGiveFromISR_Stub
#define vTaskGenericNotifyGiveFromISR_ExpectWithArray(xTaskToNotify, uxIndexToNotify, pxHigherPriorityTaskWoken, pxHigherPriorityTaskWoken_Depth) vTaskGenericNotifyGiveFromISR_CMockExpectWithArray(__LINE__, xTaskToNotify, uxIndexToNotify, pxHigherPriorityTaskWoken, pxHigherPriorityTaskWoken_Depth)
...
#define ulTaskGenericNotifyTake_IgnoreAndReturn(cmock_retval) ulTaskGenericNotifyTake_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void ulTaskGenericNotifyTake_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, uint32_t cmock_to_return);
#define ulTaskGenericNotifyTake_StopIgnore() ulTaskGenericNotifyTake_CMockStopIgnore()
...
typedef uint32_t (* CMOCK_ulTaskGenericNotifyTake_CALLBACK)(UBaseType_t uxIndexToWaitOn, BaseType_t xClearCountOnExit, TickType_t xTicksToWait, int cmock_num_calls);
...
#define ulTaskGenericNotifyTake_StubWithCallback ulTaskGenericNotifyTake_Stub
...
#define xTaskGenericNotifyStateClear_IgnoreAndReturn(cmock_retval) xTaskGenericNotifyStateClear_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void xTaskGenericNotifyStateClear_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, BaseType_t cmock_to_return);
#define xTaskGenericNotifyStateClear_StopIgnore() xTaskGenericNotifyStateClear_CMockStopIgnore()
...
typedef BaseType_t (* CMOCK_xTaskGenericNotifyStateClear_CALLBACK)(TaskHandle_t xTask, UBaseType_t uxIndexToClear, int cmock_num_calls);
...
#define xTaskGenericNotifyStateClear_StubWithCallback xTaskGenericNotifyStateClear_Stub
...
#define ulTaskGenericNotifyValueClear_IgnoreAndReturn(cmock_retval) ulTaskGenericNotifyValueClear_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void ulTaskGenericNotifyValueClear_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, uint32_t cmock_to_return);
#define ulTaskGenericNotifyValueClear_StopIgnore() ulTaskGenericNotifyValueClear_CMockStopIgnore()
...
typedef uint32_t (* CMOCK_ulTaskGenericNotifyValueClear_CALLBACK)(TaskHandle_t xTask, UBaseType_t uxIndexToClear, uint32_t ulBitsToClear, int cmock_num_calls);
...
#define ulTaskGenericNotifyValueClear_StubWithCallback ulTaskGenericNotifyValueClear_Stub
...
#define xTaskGetCurrentTaskHandleForCPU_IgnoreAndReturn(cmock_retval) xTaskGetCurrentTaskHandleForCPU_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void xTaskGetCurrentTaskHandleForCPU_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, TaskHandle_t cmock_to_return);
#define xTaskGetCurrentTaskHandleForCPU_StopIgnore() xTaskGetCurrentTaskHandleForCPU_CMockStopIgnore()
void xTaskGetCurrentTaskHandleForCPU_CMockStopIgnore(void);
#define xTaskGetCurrentTaskHandleForCPU_ExpectAndReturn(cpuid, cmock_retval) xTaskGetCurrentTaskHandleForCPU_CMockExpectAndReturn(__LINE__, cpuid, cmock_retval)
...
typedef TaskHandle_t (* CMOCK_xTaskGetCurrentTaskHandleForCPU_CALLBACK)(BaseType_t cpuid, int cmock_num_calls);
...
#define xTaskGetCurrentTaskHandleForCPU_StubWithCallback xTaskGetCurrentTaskHandleForCPU_Stub
#define xTaskGetCurrentTaskHandleForCPU_IgnoreArg_cpuid() xTaskGetCurrentTaskHandleForCPU_CMockIgnoreArg_cpuid(__LINE__)
void xTaskGetCurrentTaskHandleForCPU_CMockIgnoreArg_cpuid(UNITY_LINE_TYPE cmock_line);
#define xTaskGetIdleTaskHandleForCPU_IgnoreAndReturn(cmock_retval) xTaskGetIdleTaskHandleForCPU_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void xTaskGetIdleTaskHandleForCPU_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, TaskHandle_t cmock_to_return);
#define xTaskGetIdleTaskHandleForCPU_StopIgnore() xTaskGetIdleTaskHandleForCPU_CMockStopIgnore()
void xTaskGetIdleTaskHandleForCPU_CMockStopIgnore(void);
#define xTaskGetIdleTaskHandleForCPU_ExpectAndReturn(cpuid, cmock_retval) xTaskGetIdleTaskHandleForCPU_CMockExpectAndReturn(__LINE__, cpuid, cmock_retval)
...
typedef TaskHandle_t (* CMOCK_xTaskGetIdleTaskHandleForCPU_CALLBACK)(UBaseType_t cpuid, int cmock_num_calls);
...
#define xTaskGetIdleTaskHandleForCPU_StubWithCallback xTaskGetIdleTaskHandleForCPU_Stub
#define xTaskGetIdleTaskHandleForCPU_IgnoreArg_cpuid() xTaskGetIdleTaskHandleForCPU_CMockIgnoreArg_cpuid(__LINE__)
void xTaskGetIdleTaskHandleForCPU_CMockIgnoreArg_cpuid(UNITY_LINE_TYPE cmock_line);
#define xTaskGetAffinity_IgnoreAndReturn(cmock_retval) xTaskGetAffinity_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void xTaskGetAffinity_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, BaseType_t cmock_to_return);
#define xTaskGetAffinity_StopIgnore() xTaskGetAffinity_CMockStopIgnore()
void xTaskGetAffinity_CMockStopIgnore(void);
#define xTaskGetAffinity_ExpectAndReturn(xTask, cmock_retval) xTaskGetAffinity_CMockExpectAndReturn(__LINE__, xTask, cmock_retval)
void xTaskGetAffinity_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, TaskHandle_t xTask, BaseType_t cmock_to_return);
typedef BaseType_t (* CMOCK_xTaskGetAffinity_CALLBACK)(TaskHandle_t xTask, int cmock_num_calls);
...
#define xTaskGetAffinity_StubWithCallback xTaskGetAffinity_Stub
#define xTaskGetAffinity_IgnoreArg_xTask() xTaskGetAffinity_CMockIgnoreArg_xTask(__LINE__)
...
typedef portDONT_DISCARD void (* CMOCK_vTaskSwitchContext_CALLBACK)(int cmock_num_calls);

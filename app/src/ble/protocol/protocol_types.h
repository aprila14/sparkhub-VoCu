...
{
    I2A_WIFI_AUTH_OPEN = 0,         /**< authenticate mode : open */                //auth method tested
    // WIFI_AUTH_WEP = 1,              /**< authenticate mode : WEP */
    I2A_WIFI_AUTH_WPA_PSK = 2,          /**< authenticate mode : WPA_PSK */         //auth method not tested
    I2A_WIFI_AUTH_WPA2_PSK = 3,         /**< authenticate mode : WPA2_PSK */        //auth method tested
    I2A_WIFI_AUTH_WPA_WPA2_PSK = 4,     /**< authenticate mode : WPA_WPA2_PSK */    //auth method not tested
    // WIFI_AUTH_WPA2_ENTERPRISE = 5,  /**< authenticate mode : WPA2_ENTERPRISE */
    I2A_WIFI_AUTH_WPA3_PSK = 6,         /**< authenticate mode : WPA3_PSK */        //auth method tested
    I2A_WIFI_AUTH_WPA2_WPA3_PSK = 7,    /**< authenticate mode : WPA2_WPA3_PSK */   //auth method not tested

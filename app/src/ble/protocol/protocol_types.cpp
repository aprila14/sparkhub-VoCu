...
TWiFiCredentials::TWiFiCredentials() : ssid{}, password{}, authorizationMode{}
{
}
...
bool TCertificatePack::setFullChainCertificate(const std::string& newFullChainCertificate)
{
    ...
    {
        LOG_ERROR(
            "Fullchain certificate too long, length: %d, max length: %d",
            newFullChainCertificate.size(),
            MAX_FULLCHAIN_CERTIFICATE_LENGTH);
        return false;
    }

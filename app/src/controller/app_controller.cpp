...
AppController::AppController(LightControlInterface* pLightControlInterface,
...
m_pLightControlInterface(pLightControlInterface),
...
LightControlInterface* AppController::getLightControlInterface() const
{
    return m_pLightControlInterface;
}
...
bool AppController::executeEvent(AppController::TEventControl& eventControl)
{
    ...
    switch (eventControl.type)
    {
        ...
        case EEventType::LIGHT_CONTROL__SET_POWER:
            result = executeEvent_lightControlSetPower(eventControl.data.lightControlSetPower);
            break;
...
bool AppController::executeEvent_lightControlSetPower(const TLightControlSetPowerEventData& eventData) const
{
    return m_pLightControlInterface->setPower(eventData.percentage);
}
